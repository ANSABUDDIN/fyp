...
import CreateVendor from "@/form/CreateVendor";
...
const Vendor = () => {
  ...
  const { data, isPending, refetch } = useQuery({
    queryKey: ["vendor", debouncedValue, pagination],
    queryFn: async () => {
      return vendorService.getAll(paramsTemp);
    },
  });
  ...
  return (
    <>
      ...
      <Drawer
        size="large"
        title={`${isEdit ? "Update" : "Create"} Vendor`}
        closeIcon={false}
        extra={
          <CircleX
            color={primaryColor}
